...
const LoginPage = () => {
  ...
  return (
    <section className="flex h-screen w-full items-center justify-center">
      <main className="flex gap-10 rounded-2xl bg-white p-3 shadow-2xl">
        <div className="flex h-[480px] flex-col items-start px-5 py-10 sm:w-[350px]">
          ...
          <h1 className="text-2xl font-bold text-orange-700/80">
            Bem-vindo de volta
          </h1>
          <p className="mb-9 text-sm text-blue-800/50">
        ...
        <aside className="relative hidden items-end sm:flex">
